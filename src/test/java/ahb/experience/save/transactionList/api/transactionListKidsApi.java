...
public class transactionListKidsApi extends BaseApi {

    @Inject
    AuthConfiguration authConfiguration;

    public TransactionListResponseSchema transactionList_kidApi(String BearerToken, String accountNumber, String relationshipId){
