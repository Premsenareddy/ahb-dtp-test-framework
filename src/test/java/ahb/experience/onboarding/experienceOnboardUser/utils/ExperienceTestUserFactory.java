...
import ahb.experience.onboarding.experienceOnboardUser.api.*;
...
public class ExperienceTestUserFactory {
    ...
    @Inject
    saveMarketPlaceDetails saveMarketPlaceDetails;
    @Inject
    bankingUserLogin_Para bankingUserLogin;
    @Inject
    VerifyMobileNumber verifyMobileNumber;
    @Inject
    getIDNOWDetails getIDNOWDetails;
    @Inject
    createApplicantID createApplicantID;
    @Inject
    scanDocument scanDocument;
    @Inject
    saveIDNowUser saveIDNowUser;
    @Inject
    saveResidentialAddress saveResAddress;
    @Inject
    saveEmploymentDetails saveEmploymentDetails;
    @Inject
    saveFATCADetails saveFATCADetails;
    @Inject
