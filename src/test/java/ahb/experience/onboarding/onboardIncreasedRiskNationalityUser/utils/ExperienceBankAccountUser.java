...
public class ExperienceBankAccountUser {
    ...
    public ExperienceLoginResponse bankAdultUserOnboardRiskRejection(BankingUserOnboardingDto bankingUserOnboardingDto, ExperienceTestUser experienceTestUser, Map<String, String> queryParams){
