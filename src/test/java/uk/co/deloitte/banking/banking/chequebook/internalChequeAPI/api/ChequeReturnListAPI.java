...
public class ChequeReturnListAPI extends BaseApi {

    @Inject
    public TemenosConfig temenosConfig;

    public final String CHEQUE_RETURN_LIST = "/internal/v1/cheque/inward/returnList/";

    public String ChequeReturnList_requestPayload(String accountId){
        ...
        return given()
                ...
                .when()
                .get(temenosConfig.getWebhook_url()+CHEQUE_RETURN_LIST)
