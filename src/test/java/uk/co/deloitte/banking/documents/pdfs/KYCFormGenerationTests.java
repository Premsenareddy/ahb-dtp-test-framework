...
public class KYCFormGenerationTests {
    ...
    public void happy_path_generate_KYC_form() {
        TEST("AHBDB-5700: AC1 - Generate KYC Form");
        TEST("AHBDB-7854: AC1 Positive Test - Happy Path Scenario - Generate KYC Form");
        ...
        await().atMost(30, SECONDS).with()
                ...
                .untilAsserted(() ->
                {
                    DocumentRead1 documentRead1 = this.documentAdapterApi.getDocumentList(alphaTestUser, "KYC", 200);
