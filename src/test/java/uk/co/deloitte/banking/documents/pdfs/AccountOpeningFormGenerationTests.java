...
public class AccountOpeningFormGenerationTests {
    ...
    public void happy_path_generate_Account_Opening_form() {
        TEST("AHBDB-5699: AC1 - Generate Account Opening Form");
        TEST("AHBDB-7842: AC1 Positive Test - Happy Path Scenario - Generate Account Opening Form");
        ...
        await().atMost(30, SECONDS).with()
                ...
                .untilAsserted(() ->
                {
                    DocumentRead1 documentRead1 = this.documentAdapterApi.getDocumentList(alphaTestUser, "AC_OPEN",200);
