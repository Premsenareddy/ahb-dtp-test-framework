...
public class IBANFormGenerationTests {
    ...
    public void happy_path_generate_IBAN_form() {
        TEST("AHBDB-5701: AC1 - Generate IBAN Form");
        TEST("AHBDB-7438: AC1 Positive Test - Happy Path Scenario - Generate IBAN Form");
        ...
        await().atMost(30, SECONDS).with()
                ...
                .untilAsserted(() ->
                {
                    DocumentRead1 documentRead1 = this.documentAdapterApi.getDocumentList(alphaTestUser, "IBAN", 200);
